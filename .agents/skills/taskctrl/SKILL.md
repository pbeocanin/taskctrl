...
Inside the taskctrl repo Codex picks this skill up from `.agents/skills/` as-is. Copied
to `~/.codex/skills/taskctrl/` (or `~/.agents/skills/taskctrl/` on newer Codex builds)
